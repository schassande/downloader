(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('downloaderApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-downloaderApp-error');
                var entityKey = httpResponse.headers('X-downloaderApp-params');
                if (errorHeader) {
